...
Learning Salesforce–Java integration patterns using **Spring Boot**, **REST APIs**, and **environment variable configuration**.  
...
- `application.yml` → Contains Salesforce instance URL and API version config
...
Configuration for Salesforce is in `src/main/resources/application.yml`.  
